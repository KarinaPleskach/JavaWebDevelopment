...
public class ByRecordTest {

    private static Specification specification;

    @Before
    public void before() throws DAOException {
        specification = new SpecificationFabric("song").getSpecification("record");
    }
    ...
    public void matchFalseTest() {
        Record record = new Minus("a", new Duration(2, 2), new SoloArtist("AAnimal"), Styles.ROCK);
        boolean actual = specification.match(record);
        assertFalse(actual);
    }
